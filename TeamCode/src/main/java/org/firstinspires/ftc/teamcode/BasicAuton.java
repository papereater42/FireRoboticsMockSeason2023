...
public class BasicAuton extends LinearOpMode {
    ...
    public void runOpMode() {
     ...
     drive(4.45, 1000,true,false);
        ...
        rotate(87-activeLocation.getTrimmedAngleInDegrees(), true);
       //drive(2);
        //strafe(4.5, true);
...
//        drive(0.9, 2000);
        ...
        rotate(-activeLocation.getTrimmedAngleInDegrees(), true);
        //drive(2);
        //strafe(4.5, true);
